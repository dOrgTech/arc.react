...
export const TestArcConfig = new ArcConfig(
  ...
  "https://rinkeby.subgraph.daostack.io/subgraphs/name/v20",
  "wss://ws.rinkeby.subgraph.daostack.io/subgraphs/name/v20",
  {
...
export const ProdArcConfig = new ArcConfig(
  ...
  "https://subgraph.daostack.io/subgraphs/name/v20",
  "wss://ws.subgraph.daostack.io/subgraphs/name/v20",
  {
